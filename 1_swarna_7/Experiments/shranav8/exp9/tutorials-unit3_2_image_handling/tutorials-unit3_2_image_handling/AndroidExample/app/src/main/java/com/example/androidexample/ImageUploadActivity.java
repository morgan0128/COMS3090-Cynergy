...
public class ImageUploadActivity extends AppCompatActivity {
    ...
    private static String UPLOAD_URL = "https://0010ad92-2045-4d77-8aa1-a71ce691fb82.mock.pstmn.io/uploadImage";
        ...
        MultipartRequest multipartRequest = new MultipartRequest(
                ...
                response -> {
                    ...
                    try {
                        ...
                        rsp = jsonResponse.getString("status");
