...
public class AllTicketFragment extends Fragment implements AdminTicketAdapter.TicketActionListener {
    ...
    public static AllTicketFragment newInstance(int adminId) {
        AllTicketFragment f = new AllTicketFragment();
        Bundle b = new Bundle();
    ...
    private void loadAllTickets() {
        ...
        String url = BASE_URL + "/api/adminIssue/all";
